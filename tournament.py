...
# from game_agent import score_helper
...
def play_round(cpu_agent, test_agents, win_counts, num_matches, time_limit=TIME_LIMIT):
...
def play_matches(cpu_agents, test_agents, num_matches, time_limit = TIME_LIMIT):
    ...
    for idx, agent in enumerate(cpu_agents):
        ...
        counts = play_round(agent, test_agents, wins, num_matches, time_limit=time_limit)
